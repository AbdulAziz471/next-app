...
interface HoverBorderGradientProps
  ...
  as?: React.ElementType; // Flexible component type
...
export function HoverBorderGradient({
  ...
  containerClassName,
  className,
  as: Tag = "button", // Default to button if not provided
  duration = 1,
  clockwise = true,
  ...props
  ...
  // Rotate the border gradient direction
  ...
  // Mapping for the moving gradient directions
  ...
  // Automatically rotate the gradient when not hovered
  useEffect(() => {
    if (!hovered) {
